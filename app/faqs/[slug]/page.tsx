    ...
    <div className="relative max-w-xl mx-auto">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-3 text-sm border border-slate-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 bg-white shadow-sm transition-all duration-200"
          placeholder="Search other university questions..."
        />
        {query && (
          <button
            onClick={() => {
              ...
              <div className="py-1">
                {searchResults
                  ...
                  <Link
                    ...
                    className="block px-4 py-2 hover:bg-purple-50 transition-colors duration-150"
                    onClick={() => {
                      setIsOpen(false);
                      setQuery('');
                    }}
                  >
                    <div className="flex items-start gap-2">
                      <div className="w-1.5 h-1.5 bg-purple-100 rounded-full mt-2 flex-shrink-0"></div>
                      ...
                      <svg className="w-3 h-3 text-purple-600 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const CitationBox = ({ question, url, theme = 'purple' }: CitationBoxProps) => {
...
export default function FaqPage({ params }: FaqPageProps) {
  ...
  const faqUrl = `https://www.goingtounifaqs.com/faqs/${slug}`;
    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "isPartOf": {
              "@type": "WebSite",
              "@id": "https://www.goingtounifaqs.com/#website",
              "url": "https://www.goingtounifaqs.com",
              "name": "Going To Uni FAQs",
              "description": "Quick answers to your university and college questions",
              "publisher": {
                "@type": "Organization",
                "@id": "https://www.goingtounifaqs.com/#organization",
                "name": "Harpoon Productions Ltd",
                "logo": {
                  "@type": "ImageObject",
                  "url": "https://www.goingtounifaqs.com/goingtounifaqs.png"
                }
              }
            },
            "mainEntity": {
      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 mb-8" style={{ maxWidth: '1600px' }}>
        <div className="flex items-center gap-4 text-sm">
          ...
          <span className="text-slate-600 font-medium">University Question</span>
        </div>
      </div>
